...
def extract_regions(starting_fasta, blast_hits, upstream_bases=1000, downstream_bases=1000):
...
def main():
    ...
    extractions = extract_regions(input_fasta, results, upstream_bases=int(args.upstream), downstream_bases=int(args.downstream))
    with open(output_fasta, 'w') as output_file:
        for k, v in extractions.items():
            print(k+',', len(v), 'bases extracted around gene.')
